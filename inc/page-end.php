    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-3">
                ...
                <p class="lead">DG Enterprise Applications</p>
            </div>
            <div class="col-sm-4">
                <h6>About Us</h6>
            ...
            <div class="col-sm-2">
                ...
                <ul class="list-unstyled list-inline">
                    ...
                    <li class="list-inline-item"><a href="https://www.snapchat.com/"><i class="fab fa-snapchat-ghost"></i></a></li>
                    <li class="list-inline-item"><a href="https://www.linkedin.com/in/david-gray-5313a433/"><i class="fab fa-linkedin-in"></i></a></li>
                </ul>
            </div>
    </div>
    </div>
